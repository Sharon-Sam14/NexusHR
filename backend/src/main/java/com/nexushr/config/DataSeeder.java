...
public class DataSeeder implements CommandLineRunner {
    ...
    public void run(String... args) {
        ...
        // 2. Seed Employees
        Employee emp1 = employeeRepository.findByEmail("alice@nexushr.com").orElseGet(() -> 
            employeeRepository.save(Employee.builder()
                .employeeName("Alice Johnson")
                .email("alice@nexushr.com")
                .phone("9876543210")
        ...
        Employee emp2 = employeeRepository.findByEmail("bob@nexushr.com").orElseGet(() -> 
            employeeRepository.save(Employee.builder()
                .employeeName("Bob Smith")
                .email("bob@nexushr.com")
                .phone("9123456780")
        ...
        Employee emp3 = employeeRepository.findByEmail("carol@nexushr.com").orElseGet(() -> 
            employeeRepository.save(Employee.builder()
        ...
        Employee emp4 = employeeRepository.findByEmail("david@nexushr.com").orElseGet(() -> 
            employeeRepository.save(Employee.builder()
                .employeeName("David Lee")
                .email("david@nexushr.com")
                .phone("9345678901")
        ...
        Employee emp5 = employeeRepository.findByEmail("eva@nexushr.com").orElseGet(() -> 
            employeeRepository.save(Employee.builder()
                .employeeName("Eva Martinez")
                .email("eva@nexushr.com")
                .phone("9456789012")
                .department("Design")
        ...
        if (attendanceRepository.count() == 0) {
            ...
            for (int i = 0; i < 5; i++) {
                ...
                for (Employee emp : employees) {
                    ...
                    if (emp.getEmployeeName().equals("Carol Williams") && i == 1) {
                        checkIn = LocalTime.of(9, 45);
                        status = AttendanceStatus.LATE;
                        remarks = "Late due to traffic";
                        hours = 8.25;
                    } else if (emp.getEmployeeName().equals("David Lee") && i == 2) {
                        checkIn = LocalTime.of(13, 0);
                        status = AttendanceStatus.HALF_DAY;
                        remarks = "Doctor's appointment";
                        hours = 5.0;
                    } else if (emp.getEmployeeName().equals("Eva Martinez") && i == 3) {
                        checkIn = null;
                        checkOut = null;
        ...
        if (leaveRequestRepository.count() == 0) {
            ...
            leaveRequestRepository.save(LeaveRequest.builder()
                    ...
                    .approvedBy("Bob Smith")
                    .approvalRemarks("Sorry, we have a critical deployment on these days.")
        ...
        if (performanceRepository.count() == 0) {
            performanceRepository.save(Performance.builder()
                    ...
                    .comments("Alice is an outstanding Senior Engineer. She successfully led the team during the API migration and has shown incredible technical and team leadership.")
            ...
            performanceRepository.save(Performance.builder()
                    ...
                    .teamworkRating(3.5)
                    .communicationRating(4.0)
                    .comments("David is putting good effort in marketing. Need to focus on tracking campaign performance KPIs.")
                    .goals("Increase conversion rates by 15% through social media campaigns.")
                    .reviewedBy("Bob Smith")
                    .status(PerformanceStatus.DRAFT)
                    .build());
        }

        // 8. Seed Recruitment Postings
        if (recruitmentRepository.count() == 0) {
            ...
            recruitmentRepository.save(Recruitment.builder()
                    ...
                    .resumeUrl("https://nexushr.com/resumes/johndoe.pdf")
        ...
        if (notificationRepository.count() == 0) {
            ...
            notificationRepository.save(Notification.builder()
                    ...
                    .message("Eva Martinez has been added to the system under Design Department.")
                    .type("EMPLOYEE")
                    .read(false)
            ...
            notificationRepository.save(Notification.builder()
                    ...
                    .message("Carol Williams has submitted a request for Annual Leave (5 days starting from " + LocalDate.now().plusDays(10) + ").")
                    .type("LEAVE")
                    .read(false)
            ...
            notificationRepository.save(Notification.builder()
                    ...
                    .message("John Doe applied for the Marketing Associate position.")
                    .type("RECRUITMENT")
                    .read(true)
            ...
            notificationRepository.save(Notification.builder()
                    ...
                    .message("Welcome Alice! You can now track your attendance, request leaves, view your payslips, and check performance reviews.")
                    .type("SYSTEM")
                    .read(true)
            ...
            notificationRepository.save(Notification.builder()
                    ...
                    .message("Bob Smith has submitted your Q1 2026 performance review. Please view and acknowledge it.")
                    .type("PERFORMANCE")
                    .read(false)
            ...
            notificationRepository.save(Notification.builder()
                    ...
                    .message("Your Sick Leave application for 3 days has been approved by Bob Smith.")
                    .type("LEAVE")
                    .read(true)
