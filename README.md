...
# H2 in-memory DB seeds automatically on startup
```
...
- HR view and Employee personal view in separate tabs
...
| `/employees` | Employee Directory | HR/Admin |
| `/departments` | Departments | HR/Admin |
| `/attendance` | Attendance | All roles |
| `/schedule` | Schedule Calendar | All roles |
| `/leave` | Leave Management | All roles |
| `/payroll` | Payroll System | All roles |
| `/performance` | Performance Reviews | All roles |
| `/recruitment` | Recruitment Board | HR/Admin |
| `/notifications` | Notifications | All roles |
| `/profile` | My Profile | All roles |
| `/insights` | AI Insights | HR/Admin only |
...
| Attendance | `GET/POST /api/attendance`, `POST /check-in/{id}`, `/check-out/{id}` |
| Leave | `GET/POST /api/leave`, `PATCH /{id}/approve`, `/{id}/reject`, `/{id}/cancel` |
| Payroll | `GET/POST /api/payroll`, `PATCH /{id}/status`, `GET /{id}/download` |
| Performance | `GET/POST/PUT/DELETE /api/performance` |
| Recruitment | `GET/POST/PUT/DELETE /api/recruitment`, `PATCH /{id}/status` |
| AI | `GET /api/ai/insights`, `/attrition`, `/skill-gaps`, `POST /api/ai/chat` |
